...
function COMPILE(){
  ...
  code.writeln(
    ...
    "void collectable(float x, float y, int n){fill(255,255,0);rect(x,y,blockSize,blockSize);textAlign(CENTER,CENTER);textSize(30);text(n,x+blockSize/2,y+blockSize/2);};"+
