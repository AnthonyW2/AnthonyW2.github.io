...
<html>
  ...
  <body onload="startJS()">
    <div id="TitleBar">
      ...
      <button class="MenuButton up1line" id="HideTitleBarBtn" onclick="toggleTitleBar()" title="Collapse the title bar">Hide Title Bar</button>
      <button class="MenuButton up1line" id="ResetBtn" onclick="resetGame()" title="DEBUG - Completely reset the game">[Debug] Reset Game</button>
      <button class="MenuButton up1line" id="ExportBtn" onclick="exportGame()" title="Export the game as JSON">Export Game</button>
      <button class="MenuButton up1line" id="ImportBtn" onclick="importGame()" title="Import the game from JSON">Import Game</button>
      <button class="MenuButton up1line" id="UndoBtn" onclick="undoMove()" title="Roll back the game by one move (limit of 10 moves by default)">Undo Move</button>
      <button class="MenuButton up1line" id="ShareBtn" onclick="shareGame()" hidden>Share Game</button>
      <button class="MenuButton up1line" id="CheckCheckBtn" onclick="checkForCheck()" title="Create an alert for every instance of check found">Check for Check</button>
      <button class="MenuButton up1line" id="CheckMateBtn" onclick="checkForMate()" title="Create an alert for every instance of checkmate found (not 100% reliable)">Check for Checkmate</button>
      <button class="MenuButton up1line" id="GameImageBtn" onclick="saveToImage()" title="Create a high-resolution image of the entire play field">Save Game to Image</button>
    </div>
